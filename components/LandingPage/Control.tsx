...
const Control = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2  w-full  flow-hide ">
      <div className="w-full flex items-center justify-center   bg-[#0047A7] py-12 md:py-0">
        <div className="w-full max-w-[370px] mx-auto flex flex-col">
          ...
          <h1
            className="text-white mt-3 font-bold text-[28px] sm:text-[32px] lg:text-[48px] "
            data-aos="fade-up"
            data-aos-duration="2000"
          >
            Expense Control
          ...
          <p
            className="text-white text-sm md:text-lg font-light mt-6"
            data-aos="fade-up"
            data-aos-duration="2000"
          >
